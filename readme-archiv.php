...
<dialog id="impressumModal" class="modal" aria-labelledby="impressumTitle">
    <div class="modal-inner">
        ...
        <table class="impressum-table">
            <tr>
                <td>Redaktion:</td>
                <td>UZH Alumni Informatik</td>
            </tr>
            <tr>
                <td>Design und Realisierung:</td>
                <td>Alpnet Engineering AG, <a href="https://www.alpnet.ch" target="_blank" rel="noopener">www.alpnet.ch</a></td>
            </tr>
            <tr>
                <td>Hosting:</td>
                <td>NetZone AG, <a href="https://www.netzone.ch" target="_blank" rel="noopener">www.netzone.ch</a></td>
            </tr>
        </table>
    </div>
</dialog>

<dialog id="nutzungModal" class="modal" aria-labelledby="nutzungTitle">
    <div class="modal-inner">
        <div class="modal-head">
            <h2 id="nutzungTitle">Nutzungsbedingungen</h2>
            <button class="modal-close" aria-label="Schliessen">&times;</button>
        </div>
        <p>Die veröffentlichten Inhalte sind ausschliesslich zum persönlichen Gebrauch bestimmt. Die Vervielfältigung, Publikation oder Speicherung in Datenbanken, jegliche kommerzielle Nutzung sowie die Weitergabe an Dritte sind nicht gestattet.</p>
        <p>Die Nutzung von Links, die von dieser Website auf Websites Dritter führen, erfolgt auf eigene Verantwortung und Gefahr. Alumni Informatik Universität Zürich übernimmt keine Verantwortung für Inhalte anderer Websites, die durch Links geöffnet wurden, und lehnt jede Haftung für deren Inhalte, Produkte und Dienstleistungen oder sonstige Angebote ab.</p>
        <p>Informationen und Angaben auf dieser Webseite erfolgen ohne Gewähr.</p>
        <p>Haftungsansprüche gegen die Alumni Informatik Universität Zürich wegen Schäden materieller oder immaterieller Art, die aus dem Zugriff oder der Nutzung bzw. Nichtnutzung der veröffentlichten Informationen, durch Missbrauch der Verbindung oder durch technische Störungen entstanden sind, werden ausgeschlossen.</p>
    </div>
</dialog>
    ...
    <div class="container footer-inner">
        ...
        <div class="footer-right">
            <nav class="footer-nav" aria-label="Footer Navigation">
                ...
                <a href="#" id="impressumLink">Impressum</a>
                <a href="#" id="nutzungLink">Nutzungs­bedingungen</a>
            </nav>
...
<script>
    ...
    // Modals
    function initModal(modalId, linkId) {
        const modal = document.getElementById(modalId);
        document.getElementById(linkId).addEventListener('click', e => { e.preventDefault(); modal.showModal(); });
        modal.querySelector('.modal-close').addEventListener('click', () => modal.close());
        modal.addEventListener('click', e => { if (e.target === modal) modal.close(); });
    }
    initModal('impressumModal', 'impressumLink');
    initModal('nutzungModal', 'nutzungLink');
</script>
